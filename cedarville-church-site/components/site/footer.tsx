...
export function Footer() {
  return (
    <footer className="mt-16 border-t border-border/70 bg-[#333132] px-4 py-12 text-white dark:border-white/10 dark:bg-[#333132] dark:text-white md:px-8">
      <div className="mx-auto grid w-full max-w-7xl gap-10 md:grid-cols-4">
        <div>
          ...
          <p className="font-heading whitespace-nowrap text-xl text-white">Cedarville Church of the Nazarene</p>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-[#74848f]">
            {navLinks.map((link) => (
              <li key={link.href}>
                <Link href={link.href} className="transition-colors hover:text-accent dark:hover:text-white">
                  {link.label}
                </Link>
              </li>
            ))}
            ...
            {socialLinks.map((social) => {
              ...
              return (
                <a
                  ...
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-primary-foreground/30 transition-colors hover:border-accent hover:text-accent dark:border-white/30 dark:text-white dark:hover:border-white dark:hover:text-white"
                >
                  {Icon}
                </a>
              );
      ...
      <div className="mx-auto mt-10 w-full max-w-7xl border-t border-primary-foreground/20 pt-6 text-sm text-[#74848f] dark:border-white/15">
        <p>
